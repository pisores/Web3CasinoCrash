...
const MUSIC_TRACKS: Record<GameType, string> = {
  lobby: "https://cdn.pixabay.com/download/audio/2022/05/27/audio_1808fbf07a.mp3", // Chill electronic
  crash: "https://cdn.pixabay.com/download/audio/2022/03/10/audio_c8c8a73467.mp3", // Intense action
  mines: "https://cdn.pixabay.com/download/audio/2021/11/25/audio_91b32e02f9.mp3", // Suspense thriller
  dice: "https://cdn.pixabay.com/download/audio/2022/10/25/audio_946f883660.mp3", // Upbeat fun
  slots: "https://cdn.pixabay.com/download/audio/2022/01/18/audio_d0c6d870a4.mp3", // Casino vibes
  plinko: "https://cdn.pixabay.com/download/audio/2022/05/16/audio_545f469438.mp3", // Playful arcade
  scissors: "https://cdn.pixabay.com/download/audio/2021/08/04/audio_bb630cc098.mp3", // Battle music
  turtle: "https://cdn.pixabay.com/download/audio/2022/03/15/audio_8cb749d484.mp3", // Racing excitement
};
...
const SOUND_EFFECTS = {
  ...
  countdown: "https://cdn.pixabay.com/download/audio/2022/03/10/audio_2dde668d05.mp3",
};
...
export function useGameAudio(gameType: GameType = "lobby") {
  ...
  const currentGameRef = useRef<GameType>(gameType);
  ...
  useEffect(() => {
    currentGameRef.current = gameType;
    ...
    const playMusic = async () => {
      try {
        ...
        const audio = new Audio(MUSIC_TRACKS[gameType]);
        audio.loop = true;
  ...
  }, [gameType, settings.musicEnabled, settings.musicVolume]);
  ...
  const playSound = useCallback((soundName: keyof typeof SOUND_EFFECTS) => {
    ...
    try {
      ...
      audio.onended = () => {
        soundRefs.current.delete(soundName);
      };
